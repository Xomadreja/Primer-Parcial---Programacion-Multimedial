     ...
     <h2>Media de Notas pos Departamento</h2>
        <table class='table'>
            ...
            <tbody>
                ...
                function dptoMedia($res,$dpto)
                {
                    $total=0;
                    $count=0;
                    while($reg=mysqli_fetch_array($res)){
                    if ($reg['dpto']==$dpto){
                        $total=$total+$reg['notaFinal'];
                        $count=$count+1;
                    }
                }
                return ($total/$count);
            ...
            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Chuquisaca"."</td>";
            echo "<td>". dptoMedia($res,"01")."</td>";
            echo "</tr>";

            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "La Paz"."</td>";
            echo "<td>". dptoMedia($res,"02")."</td>";
            echo "</tr>";
                
            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Cochabamba"."</td>";
            echo "<td>". dptoMedia($res,"03")."</td>";
            echo "</tr>";
            
            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Oruro"."</td>";
            echo "<td>". dptoMedia($res,"04")."</td>";
            echo "</tr>";
                
            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Potosi"."</td>";
            echo "<td>". dptoMedia($res,"05")."</td>";
            echo "</tr>";
                
            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Tarija"."</td>";
            echo "<td>". dptoMedia($res,"06")."</td>";
            echo "</tr>";
                
            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Santa Cruz"."</td>";
            echo "<td>". dptoMedia($res,"07")."</td>";
            echo "</tr>";
            
            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Beni"."</td>";
            echo "<td>". dptoMedia($res,"08")."</td>";
            echo "</tr>";

            $res=$ins->todasLasInscripciones();
            echo "<tr>";
            echo "<td>". "Pando"."</td>";
            echo "<td>". dptoMedia($res,"09")."</td>";
            echo "</tr>";
